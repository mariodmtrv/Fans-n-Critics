"""
Django settings for Fans_n_Critics project.
...
SECRET_KEY = '^ak1ft%xfuya_w^*!gj8cuyp+d))ln@chh9$#f5t139_f#fc0='
...
ROOT_URLCONF = 'Fans_n_Critics.urls'

WSGI_APPLICATION = 'Fans_n_Critics.wsgi.application'
